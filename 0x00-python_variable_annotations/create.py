...
""",
    "100-main.py": """#!/usr/bin/env python3

safe_first_element = __import__('100-safe_first_element').safe_first_element

print(safe_first_element.__annotations__)
""",
    "101-main.py": """#!/usr/bin/env python3
...
for k, v in annotations.items():
    print( ("{}: {}".format(k, v)))
""",
    "102-main.py": """#!/usr/bin/env python3
...
# Create each main.py file
for filename, content in main_files_content.items():
    with open(os.path.join(repo_dir, filename), 'w') as file:
        file.write(content)
    os.chmod(os.path.join(repo_dir, filename), 0o755)  # Make the file executable

print("All main.py files created successfully.")
